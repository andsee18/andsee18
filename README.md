...
## Обо мне
Я бэкенд-разработчик и студент **МТУСИ**. Специализируюсь на создании  сервисов на **Java**. Мой основной фокус - архитектура, оптимизация и проектирование. 
...
- Настройка и поддержка персональных прокси-серверов (VLESS / Shadowsocks) на **удаленных VPS** (Linux) для обеспечения стабильной работы инструментов разработки.
- Опыт работы с Docker-контейнеризацией и базовой настройкой CI/CD.
